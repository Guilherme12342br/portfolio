...
import {BsChatSquareText, BsClipboardData, BsBriefcase, BsChatSquare} from 'react-icons/bs';
...
const Nav = () => {
  ...
  <nav className="fixed bottom-2 lg.bottom-8 w-full overflow-hidden z-50">
    <div className="container max-auto">
      <center><div className='w-full bg-black/20 h-[96px] backdrop-blur-2x1 
      rounded-full max-w-[460px] nx-auto px-5 flex justify-between items-center text-2x1 text-white/50'>
